const APP_DATA = {
 "today": "2026-05-24",
 "fetched_at": "2026-05-24T04:00:53",
 "total": 139,
 "sources": {
  "TechCrunch - AI": {
   "count": 12,
   ...
   "cards": [
    {
     ...
     "is_new": true,
     "lang": "en",
     "interpretation": "光速级文本生成模型突破，将极大加速AI实时交互与内容创作。"
    },
    {
     ...
     "is_new": true,
     "lang": "en",
     "interpretation": "谷歌多模态AI模型实现任意格式转换，可能颠覆信息处理范式。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "谷歌AI眼镜体验接近成熟，但仍有细节待完善。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "AI代理需接入系统终端才能执行真实操作，数据库远不够用。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "编程未来、体育科技滥用与AI驱动科研，三大议题揭示技术变革方向。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "特朗普推迟AI安全令，担忧监管措辞阻碍技术创新与产业发展。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "马斯克与奥特曼围绕OpenAI控制权之争，暴露AI行业权力博弈内幕。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "医疗巨头引入AI，预示AI将从辅助诊断走向全人健康管理。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "AI数字分身高度还原真人，引发对身份边界与隐私安全的深度思考。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "轻量级AI数据代理工具发布，降低非技术人员使用数据库的门槛。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "阿里自研AI可自主运行35小时，兼容外部框架，国产大模型迈向工程化落地。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "探讨AI能否真正理解世界，关乎其从模式匹配到认知推理的跨越。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "Anthropic的Claude代码演示揭示了AI编程的未来趋势，无论你是否接受。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "OpenAI模型推翻离散几何核心猜想，证明AI在数学发现中的突破性潜力。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "Ramp工程师用Codex加速代码审查，展示AI如何提升软件开发效率。"
    },
    {
    ...
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "谷歌I/O大会发布Gemini Spark，或开启反重力技术新赛道。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "I/O 2026发布百项更新，显示谷歌生态系统的全面扩张野心。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "新型地球观测模型更高效，将降低遥感数据分析的门槛。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "新版轻量级模型发布，可能优化端侧或低资源场景应用。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "I/O 2026宣告智能体Gemini时代，AI从工具转向自主行动。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "PaddleOCR升级支持Transformers，文档解析能力与易用性增强。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "AWS为AI基础模型训练推理提供完整技术栈，降低企业部署门槛。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "vLLM新版本强调强化学习中正确性优先，避免早期修正带来的偏差。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "Granite 4.1模型构建细节公开，揭示企业级LLM研发的关键技术路径。"
    },
    {
     ...
     "is_new": true,
     "lang": "zh",
     "interpretation": "DeepSeek V4大幅降价吸引巨头入场，梁文锋重申AGI为终极目标。"
    },
    {
     ...
     "is_new": true,
     "lang": "zh",
     "interpretation": "探讨AI杀手级应用方向，预示行业正从技术突破转向寻找商业化爆发点。"
    },
    {
     ...
     "is_new": true,
     "lang": "zh",
     "interpretation": "王小川离开通用AI主干道，反映行业正分化出更多垂直深耕的务实路线。"
    },
    {
     ...
     "is_new": true,
     "lang": "zh",
     "interpretation": "DeepSeek-V4-Pro永久降价，预示大模型价格战加剧，普惠化趋势明显。"
    },
    {
     ...
     "is_new": false,
     "lang": "zh",
     "interpretation": "巨额融资加顶级人才，DeepSeek代码能力有望实现质的飞跃。"
    },
    {
     ...
     "is_new": false,
     "lang": "zh",
     "interpretation": "安克用AI芯片实现通话降噪突破，树立了消费电子音频技术新标杆。"
    },
    {
     ...
     "is_new": false,
     "lang": "zh",
     "interpretation": "探索AI多模态融合的中间语言，是突破当前视觉与语言模型壁垒的关键方向。"
    },
    {
     ...
     "is_new": false,
     "lang": "zh",
     "interpretation": "谷歌密集发布16项AI产品，意在巩固其技术生态主导权，压制竞争对手。"
    },
    {
     ...
     "is_new": false,
     "lang": "zh",
     "interpretation": "Anthropic重金收购API中间件公司，预示AI产业链竞争正从模型层转向连接层。"
    },
    {
     ...
     "is_new": false,
     "lang": "zh",
     "interpretation": "特斯拉急招测试员、GoPro亏损、字节新模型发布，显示AI与硬件行业正经历剧烈分化。"
    },
    {
     ...
     "is_new": false,
     "lang": "zh",
     "interpretation": "国产GPU厂商将算力推向家庭场景，挑战云端主导模式，或开启边缘AI新赛道。"
    },
    {
     ...
     "is_new": false,
     "lang": "zh",
     "interpretation": "iPhone绝版配件回归、Meta用员工数据训练AI、GoPro考虑出售，科技巨头策略分化明显。"
    },
    {
     ...
     "is_new": false,
     "lang": "zh",
     "interpretation": "中国自动驾驶企业加速出海，直接挑战特斯拉技术霸权，行业格局或将重塑。"
    },
    {
     ...
     "is_new": false,
     "lang": "zh",
     "interpretation": "从追技术到做产品，DeepSeek用精英团队推动AI真正落地，关键一步。"
    },
    {
     "title": "阿里云为什么「重构自己」？",
     ...
     "is_new": false,
     "lang": "zh",
     "interpretation": "阿里云主动变革，意在应对竞争压力与云市场增长瓶颈，决定未来走向。"
    },
    {
     ...
     "is_new": false,
     "lang": "zh",
     "interpretation": "阿里凭借生态与执行力，可能攻克OpenAI放弃的难题，展现中国AI潜力。"
    }
   ]
  },
  {
   ...
   "cards": [
    ...
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "邓白氏为AI重建企业数据库，传统数据架构已无法满足智能体需求。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "精灵图插件初版上线，让AI代理能直接调用视觉素材，拓展交互维度。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "图表插件迭代，AI代理可自动生成可视化，加速数据洞察到决策的闭环。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "核心框架持续更新，标志着开源AI代理工具正走向模块化与生态化。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "极小参数增量实现类人工作记忆，突破传统RAG的上下文瓶颈，提升AI连续性。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "企业AI代理因遗忘学习内容而频繁失败，暴露了持续学习机制的短板。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "数据可视化工具新版本，让非技术人员也能轻松创建图表。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "开放智能体排行榜发布，为评估自主AI系统性能提供基准。"
    },
    {
     ...
     "is_new": false,
     "lang": "zh",
     "interpretation": "AI Agent深度理解影视流程，短剧生产周期从月压缩至天。"
    }
   ]
  },
  {
   ...
   "cards": [
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "谷歌I/O大会对话环节聚焦AI前沿，展示技术落地与行业趋势。"
    },
    {
     ...
     "is_new": true,
     "lang": "zh",
     "interpretation": "前美团外卖负责人入局具身智能，显示餐饮机器人赛道正吸引顶级人才与资本。"
    },
    {
     ...
     "is_new": true,
     "lang": "zh",
     "interpretation": "国内首家原生机器人“大脑芯片”企业获融资，标志机器人核心硬件国产化提速。"
    },
    {
    ...
    },
    {
     ...
     "is_new": false,
     "lang": "zh",
     "interpretation": "新加坡工业机器人获资本青睐，东南亚智能制造赛道升温。"
    },
    {
     ...
     "is_new": false,
     "lang": "zh",
     "interpretation": "前美团技术负责人跨界餐饮机器人，具身智能瞄准万亿级市场。"
    }
   ]
  },
  {
   ...
   "cards": [
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "AI复活逝者声音引发伦理争议，技术边界与情感需求如何平衡？"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "美国紧急阻止AI滥用已故飞行员声音，凸显深度伪造监管漏洞。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "毕业生在就业寒冬中羞辱科技CEO，折射年轻一代对行业泡沫的愤怒。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "马斯克旗下AI的“辣评模式”被列为风险，凸显AI言论管控已成上市合规焦点。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "Google工作空间新增AI功能，提升办公自动化与协作效率。"
    },
    {
     ...
     "is_new": true,
     "lang": "zh",
     "interpretation": "昆仑万维高管指出AI无法替代五类人，企业应追求稳健而非冒进。"
    }
   ]
  },
  {
   ...
   "cards": [
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "谷歌I/O大会表明，AI驱动科学研究的路径正发生关键转变。"
    },
    {
     "title": "华泰证券：看好2026年起交换芯片在AI驱动下开启二次成长",
     "url": "<![CDATA[https://36kr.com/newsflashes/3822612389941383?f=rss]]>",
     "source": "36氪 - AI",
     "date": "2026-05-24",
     ...
     "is_new": true,
     "lang": "zh",
     "interpretation": "交换芯片受AI驱动将迎二次增长，2026年或成产业链新爆发点。"
    },
    {
     ...
     "is_new": false,
     "lang": "zh",
     "interpretation": "Manus融资回购、招聘平台破产、特斯拉FSD入华，反映AI行业资本洗牌加速。"
    }
   ]
  },
  {
   ...
   "cards": [
    {
     ...
     "is_new": true,
     "lang": "zh",
     "interpretation": "OpenAI专家分享Codex高效使用技巧，助力开发者提升代码生成质量。"
    }
   ]
  },
  {
   ...
   "cards": [
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "虚报ARR成风，AI初创估值泡沫风险加剧。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "马斯克旗下公司IPO估值惊人，市场关注其真实价值。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "SpaceX申请上市，高估值需投资者对愿景有信念。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "危机管理专家能否扭转公众对AI的信任危机，成败关乎行业形象。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "FTC重罚虚假AI监听营销，监管收紧将遏制技术滥用乱象。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "环球与Spotify协议允许AI翻唱，音乐版权与创作边界面临新挑战。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "OpenAI教育计划进入新阶段，或将改变全球AI人才培养与资源分配格局。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "绿色钢铁初创公司押注关键金属，或重塑新能源材料供应链。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "OpenAI在新加坡设立分支，加速亚太AI布局与竞争。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "推进内容溯源技术，增强AI生成信息的可信度与透明度。"
    },
    {
     ...
     "is_new": true,
     "lang": "zh",
     "interpretation": "讨论AI产业人才稀缺性，揭示未来竞争核心是懂行业又懂AI的复合型人才。"
    },
    {
     ...
     "is_new": false,
     "lang": "zh",
     "interpretation": "低成本激活企业旧系统数据价值，AI落地找到高效商业化路径。"
    },
    {
     ...
     "is_new": false,
     "lang": "zh",
     "interpretation": "速卖通品牌化与AI提效双驱动，阿里国际盈利在即，出海模式升级。"
    }
   ]
  },
  {
   ...
   "cards": [
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "美国人无法识别深度伪造，这不仅是消费者问题，更会引发企业信任危机。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "网络安全未来与气候技术转向，两大议题将重塑科技政策与投资方向。"
    },
    {
     ...
     "is_new": true,
     "lang": "zh",
     "interpretation": "Moka推出AI HR工具，显示AI正深入企业管理的具体职能场景。"
    }
   ]
  },
  {
   ...
   "cards": [
    {
     ...
     "is_new": true,
     "lang": "en",
     "interpretation": "法拉利借AI精准培养车迷，或重塑体育营销与粉丝互动模式。"
    },
    {
     ...
     "is_new": true,
     "lang": "en",
     "interpretation": "马斯克放弃地球太阳能，折射其战略重心转向太空与储能领域。"
    },
    {
     ...
     "is_new": true,
     "lang": "en",
     "interpretation": "星舰V3首飞基本成功，标志SpaceX重型火箭技术迈入新阶段。"
    },
    {
    ...
    },
    {
     ...
     "is_new": true,
     "lang": "en",
     "interpretation": "中国鱼翅贸易或遭美制裁，凸显野生动物保护与国际贸易的冲突。"
    },
    {
     "title": "On the <dl>",
     ...
     "is_new": true,
     "lang": "en",
     "interpretation": "关于HTML标签的讨论，反映网页语义化标准对开发者的持续影响。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "谷歌拟用迪斯科球图标引争议，设计风格与用户习惯的博弈再起。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "谷歌屏蔽“忽视”一词，搜索审查引发言论自由担忧。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "采购AI时忽视专业化，规模优势未必是唯一关键。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "俄卫星逼近他国雷达星，太空安全博弈升级。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "埃博拉疫情快速蔓延，全球公共卫生警报再响。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "初代Chromecast突然失效，用户对产品寿命不满。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "FCC征询《观点》是否新闻节目，政治干预媒体定性引争议。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "《黑袍纠察队》衍生剧官宣，经典IP宇宙化扩张成行业趋势。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "警方炫耀攻破加密VPN，警示“绝对安全”的网络承诺不可信。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "《曼达洛人》新作评价平庸，星战IP续作面临审美疲劳危机。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "德州起诉Meta称WhatsApp加密不实，或动摇用户对隐私的信任。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "谷歌AI搜索漏洞频出，竟无视用户指令，技术可靠性遭质疑。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "网友喊话马斯克停止强推Grok，AI产品过度营销引发反感。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "文学界对AI冲击准备不足，创作伦理与版权保护面临新挑战。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "Spotify推AI混音工具遭质疑，用户担忧其沦为商业营销噱头。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "三星芯片员工获34万美元奖金，半导体行业高薪抢人战白热化。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "维珍航空用AI优化物流，证明大模型能直接提升传统行业效率。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "谷歌AI搜索将强制改变用户习惯，即使反感也难逃技术渗透。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "海底电缆瓶颈制约中东AI算力扩张，基础设施成新战略资源。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "内存短缺推高电子产品成本，消费者将面临涨价与缺货双重压力。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "npm信任机制被攻破，软件供应链安全面临根本性挑战。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "谷歌搜索质量下滑，六款替代引擎为用户提供更多选择与隐私保障。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "这款AI吉他效果器让用户自定义音色，音乐创作工具正走向智能化。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "Spotify推出AI生成混音功能，个性化音乐体验与版权问题再成焦点。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "科技巨头动荡与AI遭公众抵触，反映AI落地正面临信任与转型双重挑战。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "在AI时代规模化创意，关键在于人机协作而非完全替代人类创造力。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "SpaceX斥资28亿美元购买燃气轮机，凸显AI数据中心能源需求的激增。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "引用SpaceX早期招股书，揭示其颠覆性商业逻辑与风险。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "在密苏里州加大社区投资，体现科技巨头下沉本地化战略。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "谷歌Beam会议新功能，用AI优化多人协作的实时体验。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "新重排序模型家族发布，或提升AI检索与生成精准度。"
    },
    {
     "title": "I/O 2026",
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "谷歌I/O大会定档2026，预示下一代AI战略与产品方向。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "AI搜索模式改变美国用户习惯，推动搜索从链接转向答案。"
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "开源多语言嵌入模型性能突破，小参数规模即可实现顶尖检索效果。"
    },
    {
    ...
    },
    {
     ...
     "is_new": false,
     "lang": "en",
     "interpretation": "开放语音识别榜单新增防刷机制，保障评测公平性与模型可比性。"
    },
    {
     ...
     "is_new": true,
     "lang": "zh",
     "interpretation": "强调AI原生人才与产业经验结合，说明跨界协作是AI落地的关键路径。"
    },
    {
     ...
     "is_new": true,
     "lang": "zh",
     "interpretation": "聚焦AI提升数字体验与转化率，表明企业正用AI直接驱动业务增长。"
    },
    {
     ...
     "is_new": false,
     "lang": "zh",
     "interpretation": "周鸿祎用AI养虾，体现AI技术正跨界进入农业，探索传统产业数字化新玩法。"
    },
    {
     ...
     "is_new": false,
     "lang": "zh",
     "interpretation": "智谱代码生成速度惊人，AI编程效率竞争进入“秒级”时代。"
    },
    {
     ...
     "is_new": false,
     "lang": "zh",
     "interpretation": "老板承认AI难复刻顶级游戏创意，技术上限与商业现实并存。"
    },
    {
     ...
     "is_new": false,
     "lang": "zh",
     "interpretation": "谷歌高管淡化失业恐慌，强调AI将重塑岗位而非消灭工作。"
    },
    {
     ...
     "is_new": false,
     "lang": "zh",
     "interpretation": "端侧AI模型落地Photoshop，本地化处理提升隐私与响应速度。"
    },
    {
     ...
     "is_new": false,
     "lang": "zh",
     "interpretation": "AI社交分身能高效交友，揭示人类社交行为正被算法重塑，引发真实关系反思。"
    },
    {
     ...
     "is_new": false,
     "lang": "zh",
     "interpretation": "英伟达营收破800亿美元后，需证明AI基建需求可持续，而非资本催生的短期泡沫。"
    },
    {
     ...
     "is_new": false,
     "lang": "zh",
     "interpretation": "抖音借Google I/O首发前沿科技计划，抢占全球科技传播话语权。"
    },
    {
     ...
     "is_new": false,
     "lang": "zh",
     "interpretation": "华为手机市场回暖、小米性能突破，国产科技品牌加速高端化竞争。"
    },
    {
     ...
     "is_new": false,
     "lang": "zh",
     "interpretation": "AI角色扮演工具兴起，用户经验分享揭示AI娱乐化应用新趋势。"
    },
    {
     ...
     "is_new": false,
     "lang": "zh",
     "interpretation": "谷歌用AI颠覆自身产品，发布会展现技术革命与自我革新的双重冲击。"
    }
   ]
  }
 ],
